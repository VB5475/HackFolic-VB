     ...
     <div className="md:flex w-full">
      ...
      <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
       <div className="text-center mb-10">
        ...
        <p>Enter your information to {isLogin ? "login" : "register"}</p>
        {isLogin ? (
         <>
          <p>For Testing Purposes</p>
          <div>
           Admin <p>email : admin@example.com , password : password123</p>
          </div>
          <div>
           Host<p>email : ravi@example.com , password : password123</p>
          </div>
          <div>
           Participant
           <p>email 1 : rahul@example.com , password : password123</p>
           <p>email 2 : priya@example.com , password : password456</p>
          </div>
         </>
        ) : null}
       </div>
