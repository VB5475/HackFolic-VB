...
const compareDates = (dateString, comparisonType) => {
 ...
 const givenDateValue =
  givenDate.year * 10000 + givenDate.month * 100 + givenDate.day;
 ...
 return async function (dispatch) {
  switch (methodName) {
   ...
   case "getAllHackathons":
    result = await getUsers(
     "hosts",
     "https://hackfolic-vb-8.onrender.com/hackathons"
    );
    if (result.success) {
   ...
   case "getAllHackathonsApplications":
    result = await getUsers(
     ...
     "https://hackfolic-vb-8.onrender.com/hackathonApplications"
    );
   ...
   case "AddNewHackathon":
    ...
    result = await postMethod(
     "https://hackfolic-vb-8.onrender.com/hackathons",
     JSON.stringify(newHackathonDetails)
    );
    console.log(result);
    if (result.success) {
     workSuccess(true);
   ...
   case "addHackathonApplication":
    ...
    result = await postMethod(
     "https://hackfolic-vb-8.onrender.com/hackathonApplications",
     JSON.stringify(newHackathonApplication)
    );
    console.log(result);
    // if (result.success) {
    //   workSuccess(true);
